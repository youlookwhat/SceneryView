...
public class CircleWaveProgressView extends View {
    ...
    public CircleWaveProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        waveLength = typedArray.getDimension(R.styleable.CircleWaveProgressView_wave_length, DensityUtil.dip2px(context,80));
        //获取波浪高度
        waveHeight = typedArray.getDimension(R.styleable.CircleWaveProgressView_wave_height,DensityUtil.dip2px(context,15));
        //获取波浪颜色
    ...
    private void  init(Context context){
        //设置自定义View的宽高
        waveDefaultSize = DensityUtil.dip2px(context,250);
        //设置自定义View的最大宽高
        waveMaxHeight = DensityUtil.dip2px(context,300);
